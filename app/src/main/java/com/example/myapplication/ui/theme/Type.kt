 ...
 *
 * One family (system default) in multiple weights keeps the surface
 * fast, consistent, and free of font-loading overhead. Weight contrast
 * does the hierarchy work, not competing typefaces.
 */
